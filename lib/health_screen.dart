...
import 'package:health_app/sleep_screen.dart';
...
class _HealthAppState extends State<HealthApp> {
  ...
  //         return Column(
  //           children: [
  //             Text('Total Heart Rate: ${_healthDataList[index].unit}'),
  //             Text('Total Heart Rate: ${_healthDataList[index].sourceName}'),
  //             Text('Total Heart Rate: ${_healthDataList[index].unit}'),
  //             Text('Total Heart Rate: ${_healthDataList[index].type}'),
  //           ],
  //         );
  //       },
  //     ),
  ...
  Widget _content() {
    ...
    // else if (_state == AppState.HEART_RATE) {
    //   return _heartRateFetched();
    // } else if (_state == AppState.CALORIES) {
    //   return _caloriesFetched();
    // }
                ...
                children: [
                  ...
                  TextButton(
                      ...
                      style: const ButtonStyle(
                          backgroundColor:
                              MaterialStatePropertyAll(Colors.blue)),
                      child: const Text("Fetch Heart beat Data",
                          style: TextStyle(color: Colors.white))),
                  TextButton(
                      onPressed: () {
                        Navigator.push(context, MaterialPageRoute(
                  ...
                  TextButton(
                      ...
                      style: const ButtonStyle(
                          backgroundColor:
                              MaterialStatePropertyAll(Colors.blue)),
                      child: const Text("Fetch Calorise burned",
                          style: TextStyle(color: Colors.white))),
                  TextButton(
                      onPressed: () {
                        Navigator.push(context, MaterialPageRoute(
